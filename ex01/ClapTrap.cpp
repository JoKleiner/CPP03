...
/*   Updated: 2025/05/20 12:46:09 by joklein          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name){
	std::cout << "Setname ClapTrap constructor called" << std::endl;
	m_name = name;
	m_hit_points = 10;
	m_energy_points = 10;
	m_attack_dmg = 0;
...
void ClapTrap::takeDamage(unsigned int amount){
	...
	std::cout << m_name << " | hit-points: " << m_hit_points << ", energy-points: " << m_energy_points << std::endl;
}

void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->m_hit_points <= 0)	{
		std::cout << m_name << " is out of hit-points" << std::endl;
		return ;
	}
	if (this->m_energy_points <= 0)	{
		std::cout << m_name << " is out of energy-points" << std::endl;
		return ;
	}
	std::cout << this->m_name << " repaires " << amount << " Hit-points!" << std::endl;
	this->m_hit_points += amount;
	this->m_energy_points--;
	std::cout << m_name << " | hit-points: " << m_hit_points << ", energy-points: " << m_energy_points << std::endl;
}
